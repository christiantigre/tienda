    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="form-horizontal form-label-left" >
                ...
                @if(empty($data['key_google']))

                    <span class="section">Para utilizar el posicionamiento de la empresa debe configurar la geolocalización.</span>
                ...
                <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="enlace_recepcion">Enlace Recepcion<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {!! Form::text('enlace_recepcion',null,    array('class'=>'form-control col-md-7 col-xs-12','placeholder'=>'','autofocus'=>'autofocus','autocomplete'=>'off'
                        ) )  !!}
                    </div>
                </div>

                <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="enlace_autorizacion">Enlace Autorizacion<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {!! Form::text('enlace_autorizacion',null,    array('class'=>'form-control col-md-7 col-xs-12','placeholder'=>'','autofocus'=>'autofocus','autocomplete'=>'off'
                        ) )  !!}
                    </div>
                </div>
                ...
                <span class="section">Firma Electrónica</span>
                ...
                {{--
                <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Clave<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        {!! Form::password('passcertificate',null,    array('class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Ingrese la clave...','autofocus'=>'autofocus','autocomplete'=>'off', 'class'=>'form-control' 
                        ) )  !!}
                    </div>
                </div>
                --}}
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 input-group" id="show_hide_password">
                      <input class="form-control" type="password" id="passcertificate" name="passcertificate" placeholder="Ingrese la clave..." autofocus="autofocus" autocomplete="off" value="{{ $data['passcertificate'] }}">
            ...
            <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Fecha caduca<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">

                    {!! Form::text('fecha_caduca',null,    array('class'=>'form-control col-md-7 col-xs-12 datepicker','placeholder'=>'Ingrese la clave...','autofocus'=>'autofocus','autocomplete'=>'off'
                    ) )  !!}
                </div>
            </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key={{$data['key_google']}}&signed_in=true&callback=initMap"></script>
<script type="text/javascript">
