...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Marcas <small>de productos</small></h2>
                ...
                <div class="x_content">
                    ...
                    <a href="{{ route('admin.brand.create') }}" class="btn btn-success">
                    	<i class="fa fa-plus-circle"></i> Marcas</a>                  
                	</h1>                	
                    	</div>
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      	...
                      	<tr>
                      		<td>
                      			{!! Form::open(['route'=> ['admin.brand.destroy', $brand]]) !!}
                      		...
                      		<td>
                      		  ...
                      		  <td><h3>{{ $brand->brand }}</h3></td>
                            <td><h3>{{ $brand->isactive_id ==1 ? "Si" : "No" }}</h3></td>
                      </tr>
						@endforeach
			      </tbody>
                  </table>
