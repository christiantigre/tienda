	...
	<div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <a href="{{ route('admin.person.create') }}" class="btn btn-success">
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      	...
                      	<tr>
                          <td>
                            <a href="{{ route('admin.person.show',$emp->id) }}" class="btn btn-default">
                              <i class="fa fa-eye"></i>
                            </a>
                          </td>
                      		<td>
                      			{!! Form::open(['route'=> ['admin.person.destroy', $emp->id]]) !!}
                      		...
                      		<td>
                      			<a href="{{ route('admin.person.edit',$emp->id) }}" class="btn btn-warning">
