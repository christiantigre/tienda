	...
	<div><div></div><div></div></div>
            <center>
            	...
            	<table style="min-width:100%;border-collapse:collapse" border="0" cellpadding="0" cellspacing="0" width="100%">
                    <thead style="color:#FE980F;background-color: #FE980F">
                    	<tr style="max-width:100%;min-width:100%;border-collapse:collapse">
                    	</tr>
                    </thead>
                    <tbody>
                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="padding-top:0;padding-right:18px;padding-bottom:9px;padding-left:18px;word-break:break-word;color:#202020;font-family:Helvetica;font-size:16px;line-height:150%;text-align:left" valign="top">
                                                ...
                                                ¡Hola!<br>
                                                Si estás de acuerdo en realizar el <strong> cambio de tu clave</strong> puedes hacer click en el siguiente enlace <strong>más abajo</strong>.
                                                <br>                                              

												<strong> Click en el enlace para cambiar tu clave: </strong>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="padding-top:0;padding-right:18px;padding-bottom:18px;padding-left:18px" align="center" valign="top">
                                                                <table style="border-collapse:separate!important;border-radius:3px;background-color:#FE980F" border="0" cellpadding="0" cellspacing="0">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style="font-family:Arial;font-size:16px;padding:15px" align="center" valign="middle">
                                                <a title="Cambiar mi clave" href="{{ $link = url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset()) }}" 
                                                	style="font-weight:bold;letter-spacing:normal;line-height:100%;text-align:center;text-decoration:none;color:#ffffff;display:block" target="_blank" 
                                                	data-saferedirecturl="https://www.google.com/url?hl=es&amp;q=http://crehana.us10.list-manage1.com/track/click?u%3Da2cea3044d924acccfa40983b%26id%3D9917e16533%26e%3Dc8015e356f&amp;source=gmail&amp;ust=1471026679493000&amp;usg=AFQjCNFvQB9-TwOPP3dus4McyiVfG-7XBg">Cambiar mi clave</a>
                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                ...
                                                                <table style="border-collapse:collapse" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tbody><tr>
                                                                            ...
                                                                            <td style="padding-top:9px;padding-right:18px;padding-bottom:9px;padding-left:18px;word-break:break-word;color:#656565;font-family:Helvetica;font-size:12px;line-height:150%;text-align:center" valign="top">
                                                                                ...
                                                                                <em>Copyright © 2016 Crehana, All rights reserved.</em>
                                                                                <br>
