...
class Router implements RegistrarContract
{
    ...
    {
        //Router modificado para registrar un usuario y cliente al momento de registrarse el usuario
        ...
        /*$this->get('confirm/email/{email}/comfirm_token/{ comfirm_token }', 'Auth\AuthController@confregister');*/
        /*$this->get('confirm/email/{email}/comfirm_token/{ comfirm_token }', 'Auth\AuthController@comfirmregister');*/
