...
use App\Http\Controllers\developerAlertController; 
...
class CarritoController extends Controller
{
    ...
    public function firmarXml($nombrexml)
    {
        ...
        $notificacionesSistema = new developerAlertController();
        ...
        if($res_firmado['firmado'] === true){
            ...
            $notificar  = $notificacionesSistema->alertaDeveloperMantenimiento('Factura generada no se pudo firmar, revisar la validez y credenciales de la firma electronica.','incidencia');
            
            /* notificar al usuario que su compra su pedido se realizo con exito, y que en breves momentos se le notificara mediante correo electonico el estado de su compra.*/
            $message = 'Su pedido fue realizado con éxito, estamos preparando tu factura y la enviarémos a tu correo electrónico';
