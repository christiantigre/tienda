					...
					<div class="col width-68 append-02">
						<div class="box">
							...
							<div class="box-content">
								...
								<p>
									<a class="button" href="?firmarLote=true">Firmar documentos en lote formato XAdES en servidor</a>
								</p>
							</div>
						</div>
					</div>
					...
					*/
					if ($_GET["firmarLote"] == true) {
						try {
							...
							$idFirmaLote = $viafirmaClient->signByServerEnLotes($idLote,$certAlias,$certPass);
							
							echo "<div class=\"box\"> <h2 class=\"box-title\">Ejemplo</h2> <div class=\"box-content\">";
							echo "<p><strong>Tipo de firma: </strong>XAdES<br/>";
							echo "<strong>Id de firma del lote:</strong>$idFirmaLote<br/>";
							echo "<strong>Archivos incluidos en el lote:</strong><ul><li>Documento 1.txt</li><li>Documento 2.xml</li><li>Documento 3.pdf</li></ul</p>";
							echo "</div></div>";
