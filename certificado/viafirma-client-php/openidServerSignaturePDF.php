					...
					<div class="col width-58 append-02">
						<div class="box">
							...
							<div class="box-content">
								...
								<p>
									<a class="button" href="?firmarPDF=true">Firma de PDF en formato PDF Signature en servidor</a>
								</p>
							</div>
						</div>
					</div>
					...
					*/
					if ($_GET["firmarPDF"] == true) {
						...
						try {
							...
							$filenameWithField = "resource/exampleSignWithField.pdf";
							$fileWithField = fopen($filenameWithField, 'r');
							$datosWithField = fread($fileWithField, filesize($filenameWithField));
							...
							//$idFirma = $viafirmaClient->signByServerPDFWithImageStamp("documentoFirmado.pdf",$datos,$certAlias,$certPass,$datosRectangle,$datosImage);
							
							/* Firma con Stamp At Field */							
							//$fieldName = "SIGNATURE_FIELD";
							//$idFirma = $viafirmaClient->prepareFirmaPDFWithImageStampAtField("documentoFirmado.pdf", $datosWithField, $fieldName, $datosImage);														
