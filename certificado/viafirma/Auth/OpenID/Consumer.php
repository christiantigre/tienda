 ...
 */
require_once "viafirma/Auth/OpenID.php";
require_once "viafirma/Auth/OpenID/Message.php";
require_once "viafirma/Auth/OpenID/HMAC.php";
require_once "viafirma/Auth/OpenID/Association.php";
require_once "viafirma/Auth/OpenID/CryptUtil.php";
require_once "viafirma/Auth/OpenID/DiffieHellman.php";
require_once "viafirma/Auth/OpenID/KVForm.php";
require_once "viafirma/Auth/OpenID/Nonce.php";
require_once "viafirma/Auth/OpenID/Discover.php";
require_once "viafirma/Auth/OpenID/URINorm.php";
require_once "viafirma/Auth/Yadis/Manager.php";
require_once "viafirma/Auth/Yadis/XRI.php";
...
class Auth_OpenID_GenericConsumer {
    ...
    function _discoverAndVerify($claimed_id, $to_match_endpoints)
    {
        ...
        list($unused, $services) = call_user_func($this->discoverMethod,
                                                  $claimed_id,
												  //&$this->fetcher);
        		$this->fetcher); // PATCH VIAVANSI php 5.4
